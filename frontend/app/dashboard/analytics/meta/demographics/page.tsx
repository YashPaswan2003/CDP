...
export default function MetaDemographics() {
  const { selectedAccount } = useAccount();
  const pathname = usePathname();
  const allData = getDemographicData().filter((r) => r.platform === "meta");
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-text-primary mb-1">Meta - Demographics</h1>
