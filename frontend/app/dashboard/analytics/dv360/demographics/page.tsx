...
export default function DV360Demographics() {
  const { selectedAccount } = useAccount();
  const pathname = usePathname();
  const allData = getDemographicData().filter((r) => r.platform === "dv360");
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-text-primary mb-1">DV360 - Demographics</h1>
